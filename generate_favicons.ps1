...
# Simple ICO creation (renaming 32x32 for common compatibility if true ICO generation isn't available)
# Actually, for modern browsers, the PNGs are better. 
# We'll just copy the 32x32 to favicon.ico for basic support.
