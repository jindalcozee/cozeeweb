                ...
                {filteredProducts.map((product, idx) => (
                    <ScrollReveal key={product.id} width="100%" delay={idx % 4 * 0.1}>
                        <Link to={`/product/${product.id}`} className="group cursor-pointer flex flex-col transform transition-all duration-500 hover:-translate-y-2">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start text-lg md:text-xl font-medium text-[var(--color-rojo)]">
                                ...
                                <div className="flex flex-row md:flex-col items-center md:items-end gap-2 md:gap-1">
                                    <span className="font-bold md:font-medium">{product.price}</span>
